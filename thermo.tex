...
\begin{tikzpicture}
	...
	\draw (0.7,0) to node[near end, below=-1.2mm, sloped] {\small Isentrope} (0.7,3.5);
	\draw (0,0.7) to node[near end, below=-1.2mm, sloped] {\small Isotherme} (3.5,0.7);
	\draw (0.1,0) to[bend right=15] node[near end, below=-1.2mm, sloped] {\small Isochore} (2,3.5);
	\draw (0,0.5) to[bend right=15] node[near end, below=-1.2mm, sloped] {\small Isobare} (3.5,2.4);

	\draw (5.7,4) to node[near end, below=-1.2mm, sloped] {\small isobar} (5.7,0.5);
	\draw (5.2,3.4) to node[near end, below=-1.2mm, sloped] {\small isochor} (8.5,3.4);
...
\begin{tikzpicture}[
  ...
  arrow inside/.style = {postaction=decorate,decoration={markings,mark=at position .55 with \arrow{>}}}
	...
	\draw (0.2,0.2) to[bend right=10] (@3);
	...
	\draw (-0.2,-2.9) node[right] {$\displaystyle \eta_{th,ZÜ} = 1 - \frac{|q_{81}|}{q_{23} + q_{34} + q_{45} + q_{67}} = 1- \frac{h_8 - h_1}{h_5 -h_2 + h_7 - h_6}$};
\end{tikzpicture}
...
&
	\begin{tikzpicture}
		...
		\draw (1,3) node {\small Gleichraumverbrennung};
...
&
	...
	\begin{tikzpicture}
		...
		\draw (1,3) node {\small Gleichdruckverbrennung};
