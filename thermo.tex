...
\begin{tikzpicture}
	...
	\draw (1.7,0.28) node[fill=white, text width=5mm, text height=1.2mm, align=left] {\small $w_{v,12}$};<br>
...
\end{align*}
Dampf/Luftdruckkammer (Exergie der Enthalpie)

\begin{equation*}
	-\dot{W}_{ex,1u} = \dot{m}_1 [ u_1 - u_u + p_u ( v_1 - v_u) - T_u(s_1 - s_u)]
\end{equation*}
