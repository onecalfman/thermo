...
\begin{align*}
	...
	F &= U-TS,\quad G = \underrightswishingghost{H-TS}	\\
...
\begin{align*}
	...
	dF &= -SdT -pdV + \sum_{k=1}^{K} \mu _k dn_k \\
	dU &= \left(\frac{\partial U}{\partial S}\right)_{V} dS + \left(\frac{\partial U}{\partial V}\right)_{S} dV + \sum_{k=1}^{K} \left(\frac{\partial U}{\partial n_k}\right)_{S} dn_k  \\
