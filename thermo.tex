...
\begin{alignat*}{3}
	...
	\\
\end{alignat*}
\setlength{\belowdisplayskip}{1cm} \setlength{\belowdisplayshortskip}{1cm}
% _    __                      __              _       __            __    
...
\begin{align*}
	\eta_{th} &= 1 - \frac{|q_{ab}|}{q_{zu}} \\
	\epsilon_K &= \frac{q_zu}{w} \\
	\epsilon_{WP} &= \frac{|q_{ab}|}{w} \\
	\text{Verdichtun}&\text{gsverhältniss: } \\
	\epsilon 	&= \frac{v_1}{v_2} \\
	\text{Drucksteig}&\text{erungsverhältniss: }\\
	\psi 		&= \frac{p3}{p2} \\
	\text{Einspritz}&\text{verhältniss: }\\
	\varphi 	&= \frac{v_4}{v} \\
\end{align*}
...
%\begin{enumerate}
%	\item $\rightarrow 2:$ reversibel adiabate Verdichtung
%	\item $\rightarrow 3:$ isochore Wärmzufuhr
%	\item $\rightarrow 4:$ isobre Wärmezufuhr
%	\item $\rightarrow 5:$ reversibel adiabate Entspannung
%	\item $\rightarrow 1:$ isochore Wärmeabgabe
%\end{enumerate}
\begin{align*}
	\eta_{th} 		&= 1 - \frac{|q_{ab}|}{q_{zu}} = 1 - \frac{u_5 - u_1}{u_3 - u_2 + h_4 - h_3} \\
	\eta_{th,\text{ideal}} 	&= 1 - \frac{T_5 - T_1}{T_3 - T_2 + \kappa(T_4 - T_3)} \\
				&= 1 - \frac{T_1}{T_2}\left[\frac{\frac{T_5}{T_1}-1}{\frac{T_3}{T_2}-1 + \kappa \frac{T_3}{T_2} \left[\frac{T_4}{T_3}-1\right]}\right] \\
				&= 1 - \frac{\varphi^\kappa \psi - 1}{\epsilon^{\kappa-1}\left[\psi - 1 + \kappa \psi \left(\varphi -1 \right)\right]}
\end{align*}
...
\begin{align*}
	n_{th} &= 1 -\frac{1}{\epsilon^{\kappa  -1}} \\
	\epsilon 	&= \frac{v_1}{v_2} \\
\end{align*}
...
\begin{equation*}
	n_{th} = 1 - \frac{\varphi^\kappa - 1}{\epsilon^{\kappa -1}\kappa(\varphi - 1)}
\end{equation*}
...
\begin{equation*}
	n_{th} 1 - \frac{|q_{12}|}{q_{34}} = \frac{RT_1 \ln\left(\frac{v_1}{v_2}\right)}{RT_3 \ln \left(\frac{v_4}{v_3}\right)}= 1 - \frac{T_1}{T_3}
\end{equation*}
...
\begin{equation*}
	n_{th} = 1 - \frac{T_1}{T_2} = 1 - \left(\frac{p_1}{p_2}\right)^{\frac{\kappa-1}{\kappa}}
\end{equation*}
