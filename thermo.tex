...
\begin{tikzpicture}[
  ...
  \node[dot,label={left:$1$}] (@1) at (0.5,3) {};
  ...
  \draw[dashed,thin] (0,1) node[left] {$T_3$} -- (4,1);
...
\begin{tikzpicture}
	...
	\draw (0.1,0.3) -- node[midway, below, rotate=60] {Subl.-Linie} (0.4,0.8);
...
Van-Der-Waals-Gas  \\
	\begin{tabular}{l|l|l|l|l}
		...
		& $p_{M1}v_{M1}= p_{M2}v_{M2}$ & $\frac{RT_1}{v_{M1}} - \frac{a}{v_1^2} = \frac{RT_2}{v_M} - \frac{a}{v_2^2}$ & $\frac{p_1 + \frac{a}{v_1^2}}{T_1} = \frac{p_2 + \frac{a}{v_1^2}}{T_2}$  & $p_{M1} v_{M1}^{K_M} = p_M v_{M2}^{K_M}, \quad T_1v_{M1}^{R/c_v} = T_2 v_{M2}^{R/c_v}$  \\ \hline
